...
class SecretariasC{
    ...
    public function IngresarSecretariaC(){
        if(isset($_POST["usuario-Ing"])){
            ...
            $_POST["clave-Ing"])){    //para corroborar lo que se ponga en el nombre de usuario y la clave
    ...
    public function VerPerfilSecretariaC(){
        ...
        echo '<tr>
                ...
                if($resultado["foto"] !=""){
                    ...
                    echo '<td><img src="http://localhost:90/clinica/'.$resultado["foto"].'" class="img-responsive" width="40px"></td>';

                }else{

                    echo '<td><img src="http://localhost:90/clinica/Vistas/img/coax-logo.jpg" class="img-responsive" width="40px"></td>';
                ...
                echo '<td>
                    ...
                    <a href="http://localhost:90/clinica/perfil-S/'.$resultado["id"].'">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12">
                    ...
                    if($resultado["foto"] ==""){
                        ...
                        echo'<img src="http://localhost:90/clinica/Vistas/img/coax-logo.jpg" width="200px ">';
                    }
                    else{
                        echo'<img src="http://localhost:90/clinica/'.$resultado["foto"].'" width="200px ">';
                    }
    ...
    public function ActualizarPerfilSecretariaC(){
        ...
        if(isset($_POST["idP"])){
            ...
            if($resultado == true){
                ...
                window.location = "http://localhost:90/clinica/perfil-S/'.$_SESSION["id"].'";
                </script>';
